...
local Message = loadstring(game:HttpGet("https://raw.githubusercontent.com/frel0/FakeKickLibrary/main/FakeKickLibrary.lua
https://raw.githubusercontent.com/frel0/FakeKickLibrary/main/FakeKickLibrary.lua", true))()
Message:Crash("An unexpected error occured and Roblox needs to quit. Were sorry!")
wait(3)
Message:Kick("You have been kicked from this experience: Hello niggers this ain't open source. get logged kiddo")
wait(3)
Message:RickRoll() 
